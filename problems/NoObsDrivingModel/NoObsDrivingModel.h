#ifndef NOOBSDRIVINGMODEL_H
#define NOOBSDRIVINGMODEL_H

#include "Model.h"


class NoObsDrivingModel : public Model
{
  public:
      NoObsDrivingModel();
  ...
  private:
      double deltaT;
      double noisemean;
      double attentivenoisestddev;
	  double distractednoisestddev;
//      double c;
	  double a;
