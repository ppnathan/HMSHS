...
Beliefsfile = fopen('../../problems/TwoDModel/OutFiles/samplerecords.txt','r');

RawBeliefsData = fscanf(Beliefsfile, '%d %f %f %f %f %f %f %d %d', [9 inf]);
BeliefsData = RawBeliefsData(2:6, :)';
...
BeliefsSelectionFile = fopen('../../problems/TwoDModel/OutFiles/BeliefsSelection.txt','w');
for i = 1:nSelection
    fprintf(BeliefsSelectionFile, '%f  %f  %f  %f  %f  %f\n', RawBeliefsData(2, selectedIdx(i)), RawBeliefsData(3, selectedIdx(i)), RawBeliefsData(4, selectedIdx(i)),...
                                   RawBeliefsData(5, selectedIdx(i)), RawBeliefsData(6, selectedIdx(i)), RawBeliefsData(7, selectedIdx(i)) );
end
