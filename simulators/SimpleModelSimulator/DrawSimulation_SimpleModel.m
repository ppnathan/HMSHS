...
MatlabSimfile_Discrete = fopen('../../problems/SimpleModel/OutFiles_OldSolver5000/MatlabSimfile_Discrete.txt', 'r');
BestValueFile = fopen('../../problems/SimpleModel/OutFiles_OldSolver5000/BestValue.txt');
...
set(gca,'XLim',[0 250], 'FontSize', figurefontsize);
...
set(gca,'XLim',[0 250], 'YLim', [0 30], 'FontSize', figurefontsize);
...
save valuefunction_oldsolver.mat x b_q1 z;
end
%%
load valuefunction_oldsolver.mat
figure('Position', [0 0 1024 512]);
surf(x, b_q1, z);
xlabel('x', 'FontSize', figurefontsize); ylabel('b(q=0,x)', 'FontSize', figurefontsize); zlabel('J(b)', 'FontSize', figurefontsize);
%title('Value function', 'FontSize', figurefontsize);
