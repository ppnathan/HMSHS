...
Beliefsfile = fopen('../../problems/DrowsyDriverModel/OutFiles/samplerecords.txt','r');
...
BeliefsSelectionFile = fopen('../../problems/DrowsyDriverModel/OutFiles/BeliefsSelection.txt','w');
for i = 1:nSelection
