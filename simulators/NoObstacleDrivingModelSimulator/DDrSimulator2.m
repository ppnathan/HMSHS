...
MatlabSimulationfile = fopen('../../problems/DrowsyDriverModel/OutFiles/MatlabSimulationfile.txt', 'w');
MatlabSimfile_Discrete = fopen('../../problems/DrowsyDriverModel/OutFiles/MatlabSimfile_Discrete.txt', 'w');
